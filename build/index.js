...
const lambda = new aws.lambda.Function("lambdaFunction", {
    code: new pulumi.asset.AssetArchive({
        ".": new pulumi.asset.FileArchive("./build/src/lambda/example"),
        "node_modules": new pulumi.asset.FileArchive('./src/lambda/example/node_modules'),
    }),
    runtime: "nodejs18.x",
    role: lambdaRole.arn,
...
exports.endpoint = pulumi.interpolate `${apigw.apiEndpoint}/${stage.name}`;
